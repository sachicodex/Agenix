...
import 'screens/create_event_screen_v2.dart';
...
Future<void> main() async {
  ...
  // Load environment variables from .env (optional). If the .env file is
  // missing, dotenv.load() may throw; catch and continue so the app can run
  // using system environment variables instead.
  try {
    await dotenv.load();
  } catch (e) {
    // ignore: avoid_print
    print('.env not found or failed to load — continuing without it: $e');
  }
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        CreateEventScreenV2.routeName: (_) => const CreateEventScreenV2(),
