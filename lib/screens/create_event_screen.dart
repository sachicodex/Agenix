...
class _CreateEventScreenState extends ConsumerState<CreateEventScreen> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: Text('Create Event', style: AppTextStyles.headline2),
      centerTitle: true,
    );
  }
  ...
  Future<void> _onSavePressed() async {
    ...
    final watch = DebugPerfLogger.start('CreateEventScreen', 'saveEvent');
    try {
      ...
      DebugPerfLogger.end(
        ...
        watch,
        'saveEvent',
        data: {'calendarId': calendarId, 'eventId': event.id},
      );
